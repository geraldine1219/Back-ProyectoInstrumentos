...
import { ObtenerPensul, guardarPensul, ListarPensuls, ListarPensulsAlumnosProfesor } from "../service/pensul.service"
...
export const listAlumnoProfesorController = async (req: Request, res: Response) => {
    ...
    try {
        ...
        const result = await ListarPensulsAlumnosProfesor(idProfesor);
